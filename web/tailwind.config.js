...
export default {
  ...
  theme: {
    ...
    fontFamily: {
      sans: ['DM Sans', 'Helvetica Neue', 'Arial', 'Microsoft YaHei', 'sans-serif'],
      'dm-sans': ['DM Sans', 'sans-serif'],
      signika: ['Signika', 'sans-serif'],
    },
    extend: {
      colors: {
        // shadcn/ui compatible design tokens (oklch with alpha support)
        background: 'var(--mkt-background)',
        foreground: 'var(--mkt-foreground)',
        card: {
          DEFAULT: 'var(--mkt-card)',
          foreground: 'var(--mkt-card-foreground)',
        },
        primary: {
          DEFAULT: 'oklch(var(--mkt-primary) / <alpha-value>)',
          foreground: 'var(--mkt-primary-foreground)',
        },
        secondary: {
          DEFAULT: 'var(--mkt-secondary)',
          foreground: 'var(--mkt-secondary-foreground)',
        },
        muted: {
          DEFAULT: 'oklch(var(--mkt-muted) / <alpha-value>)',
          foreground: 'var(--mkt-muted-foreground)',
        },
        accent: {
        ...
        // Standard Tailwind colors (for homepage marketing sections)
        red: colors.red,
