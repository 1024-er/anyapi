# Any API Electron Desktop App

This directory contains the Electron wrapper for Any API, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
- **Production**:
  - macOS: `~/Library/Application Support/Any API/data/`
  - Windows: `%APPDATA%/NAnyew API/data/`
  - Linux: `~/.config/Any API/data/`
